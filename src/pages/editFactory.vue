                        ...
                        <div class="main">
                            <div class="main_left" v-show="showFinish">
                                        ...
                                        <div class="Center_left">
                                            ...
                                            <div class="details">
                                                <FormItem label="地址选择：" prop="factoryProvince">
                                                    <Select v-model="formValidate.factoryProvince" placeholder="选择省份" style="width:100px;" @on-change="selectCity">
                                                        <Option v-for="item in provinceList" :value="item.provinceid" :key="item.provinceid">{{item.province}}</Option>
                                                    </Select>
                                                    <Select v-model="formValidate.factoryCity" placeholder="选择城市" style="width:100px;" @on-change="selectArea">
                                                        <Option v-for="item in CityList" :value="item.cityid" :key="item.cityid">{{item.city}}</Option>
                                                    </Select>
                                                    <Select v-model="formValidate.factoryArea" placeholder="选择区域" style="width:100px;">
                                ...
                                <div class="main_bot">
                                    ...
                                    <Button type="primary" size="large" style="width:96px;height:40px;" @click="changeSubmit('formValidate')">确定</Button>
                                </div>
                            </div>    
    ...
    export default {
        ...
        methods:{  
            ...
            getData () {
                ...
                .then(response => {
                    if(response.data.code === 200){                
                        this.formValidate.factoryName = response.data.data.factoryResult.factoryName
                        this.formValidate.contact = response.data.data.factoryResult.contact
                        this.formValidate.developer = response.data.data.factoryResult.developer
                        this.formValidate.factoryRangeUid = response.data.data.factoryResult.factoryRangeUid
                        this.formValidate.factoryAddr = response.data.data.factoryResult.factoryAddr
                        this.formValidate.industry = response.data.data.factoryResult.industry
                        this.formValidate.factoryPropertyUid = response.data.data.factoryResult.factoryPropertyUid
                        this.formValidate.factoryProvince = response.data.data.factoryResult.factoryProvince
                        this.formValidate.factoryCity = response.data.data.factoryResult.factoryCity
                        this.formValidate.factoryArea = response.data.data.factoryResult.factoryArea
                        this.formValidate.telphone = response.data.data.factoryResult.telphone
                        this.formValidate.contractFunction = response.data.data.factoryResult.contractFunction
                        this.formValidate.faceFuntion = response.data.data.factoryResult.faceFuntion
                        this.formValidate.factoryDescription = response.data.data.factoryResult.factoryDescription
                    }else{
                        return    
                    }
                })
